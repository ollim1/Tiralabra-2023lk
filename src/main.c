...
enum algorithm_enum {HUFFMAN = 0, LZSS, LZSS_BYTE};
...
void usage()
{
    ...
    fprintf(stderr, "-a [algorithm]: compression algorithm; huff, lzss or lzss-byte\n");
    ...
    fprintf(stderr, "-t [infile]: benchmark algorithm performance without saving output\n");
    exit(EXIT_FAILURE);
}
